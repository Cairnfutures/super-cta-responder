...
function LoginForm() {
  ...
  const from = params.get('from') || '/respond'
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0f0f10', fontFamily: 'system-ui, sans-serif' }}>
      <div style={{ background: '#1a1a1f', border: '1px solid #2a2a35', borderRadius: 16, padding: '40px 36px', width: '100%', maxWidth: 380 }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <h1 style={{ color: '#fff', fontSize: 20, fontWeight: 700, margin: '0 0 6px' }}>CTA Responder</h1>
